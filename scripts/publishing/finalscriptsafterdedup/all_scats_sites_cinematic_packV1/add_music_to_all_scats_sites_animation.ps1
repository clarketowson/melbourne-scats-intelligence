...
$inputVideo = Join-Path $videoDir "all_scats_sites_animation.mp4"
$music = Join-Path $musicDir "12-Year Melbourne Evolution.mp3"
$outputVideo = Join-Path $videoDir "all_scats_sites_with_music.mp4"
