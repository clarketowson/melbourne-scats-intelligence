#!/usr/bin/env python3
r"""
generate_top_20_busiest_days_from_daily_totals.py

Builds the top 20 busiest days from the already-generated daily_totals.csv.
...
Outputs:
    A:\TrafficAnalytics\PROJECTS\reports\deduped\top_20_busiest_days.csv
    A:\TrafficAnalytics\PROJECTS\reports\deduped\top_20_busiest_days.json
"""
...
OUTPUT_CSV = REPORT_DIR / "top_20_busiest_days.csv"
OUTPUT_JSON = REPORT_DIR / "top_20_busiest_days.json"
...
def main() -> None:
    print("=" * 90)
    print("GENERATING TOP 20 BUSIEST DAYS FROM DAILY TOTALS")
    print("=" * 90)
    ...
    if rows:
        print(f"Top day               : #{rows[0][0]} | {rows[0][1]} | {fmt_int(rows[0][2])}")
    print("=" * 90)
