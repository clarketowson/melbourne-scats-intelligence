# run_generate_kepler_city_pulse_dayV2.ps1
# Exports one representative weekday of SCATS site-level 15-minute data for Kepler.gl animation.

$ErrorActionPreference = "Stop"

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$PythonScript = Join-Path $ScriptDir "generate_kepler_city_pulse_dayV2.py"

$Date = "2024-05-15"

Write-Host "Running Kepler city pulse day export V2..." -ForegroundColor Cyan
