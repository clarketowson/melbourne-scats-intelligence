#!/usr/bin/env python3
r"""
generate_busiest_time_bin_chunkedV2.py
...
- Writes monthly time-bin totals immediately
...
def main() -> None:
    ...
    try:
        ...
        append_month_rows(rows, next_month, month_elapsed)
        ...
        print(f"Running bin volume   : {fmt_int(final_payload['busiest_time_bin_total_volume'])}")
