...
def chart_busiest_sites(
    ...
    manifest.append({
        ...
        "axis_fix": "V3.7 scans all Excel sheets, prefers best descriptive site names for duplicate IDs, preserves integer-only IDs, and colour-codes Top 20 sites with a heat scale",
    })
