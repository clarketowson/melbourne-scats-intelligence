...
def chart_busiest_sites(
    ...
    manifest.append({
        ...
        "axis_fix": "V3.8 scans all Excel sheets, applies verified manual overrides for sites 2816 and 3376, preserves integer-only IDs, and colour-codes Top 20 sites with a heat scale",
    })
