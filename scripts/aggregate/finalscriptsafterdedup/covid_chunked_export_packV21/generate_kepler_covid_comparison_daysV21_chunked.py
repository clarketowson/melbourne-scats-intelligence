...
# AUTO-FIND _common_scats_kepler
# This lets the script work whether it is run from:
#   scats_next_animation_packV1
# or:
#   scats_next_animation_packV1\covid_chunked_export_packV2
import sys
...
for candidate in [
    ...
    if (candidate / "_common_scats_kepler.py").exists():
